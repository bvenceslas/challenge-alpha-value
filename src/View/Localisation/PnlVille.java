 ...
 * @author Ven
 */
public class PnlVille extends javax.swing.JPanel
{
    ClsVille ville = null;
    ...
    /**
     * Creates new form PnlVille
     */
    public PnlVille() throws SQLException, Exception 
    {
        initComponents();
        Fill_Object.charger_ComboBox(cmbProvince, "SELECT designation FROM tProvince ORDER BY designation ASC"); 
        Chargement();
    }

    public void Chargement() throws SQLException, Exception
    {
        Fill_Object.remplir_tableau(TabVille, "Select * from tVille");
    }
    /**
    ...
    private void initComponents() {
        ...
        TabVille = new javax.swing.JTable();
        ...
        TabVille.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        TabVille.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(TabVille);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try 
        {
            ...
            ville = new ClsVille();
            ville.setId(Integer.parseInt(txtId.getText()));
            ville.setDesignation(txtDesignation.getText());
            province.setDesignation(cmbProvince.getSelectedItem().toString());
            ville.setProvince(province);
            if (ville.Update())
            {
                JOptionPane.showMessageDialog(null, "Ville Enregistrée avec succès", "Reussite", JOptionPane.INFORMATION_MESSAGE); 
                Chargement();
            }
        }
        catch (Exception e) 
    ...
    private javax.swing.JTable TabVille;
